...
define dso_local i8* @"?concat@@YAPEBDPEBD0@Z"(i8* %0, i8* %1) #1 {
  ...
  %15 = call i8* @"??_U@YAPEAX_K@Z"(i64 %14) #4
...
define dso_local i32 @main() #3 {
  ...
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @"??_C@_06LGHDPPDO@Hello?5?$AA@", i64 0, i64 0), i8** %2, align 8
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @"??_C@_03MDGMGCCO@Flo?$AA@", i64 0, i64 0), i8** %3, align 8
  store i8* getelementptr inbounds ([3 x i8], [3 x i8]* @"??_C@_02LEGMHFOO@?5?$CB?$AA@", i64 0, i64 0), i8** %4, align 8
  %6 = load i8*, i8** %4, align 8
  %7 = load i8*, i8** %3, align 8
  %8 = call i8* @"?concat@@YAPEBDPEBD0@Z"(i8* %7, i8* %6)
  %9 = load i8*, i8** %2, align 8
  %10 = call i8* @"?concat@@YAPEBDPEBD0@Z"(i8* %9, i8* %8)
